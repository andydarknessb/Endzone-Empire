 ...
 * moved there too), plus the sanctioned reaches below the island:
 * `src/lib/nflTeamColors` (the touchdown sprite kits and the field green the
 * kits are checked against), `src/lib/initials` (the sprite and mobile
 * end-zone initials) and `src/components/PlayerQuickView/PlayerAvatar` (the
