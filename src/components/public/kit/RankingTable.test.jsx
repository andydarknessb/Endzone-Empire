...
describe('RankingTable states', () => {
  ...
  it('renders data rows with player profile links', () => {
    ...
    expect(screen.getByLabelText(/Proj: An estimate of fantasy points/)).toBeInTheDocument();
  });
  ...
  it('uses stacked ranking cards instead of a table below md', () => {
    ...
    expect(screen.getAllByLabelText(/Projected: An estimate of fantasy points/)).toHaveLength(2);
  });
});
