...
const documents = {
  ...
  terms: {
    ...
    sections: [
      ...
      ['Termination', 'You may delete your account through Account Settings after resolving leagues you commission. The operator may restrict accounts that violate these terms or the Acceptable Use Policy.'],
