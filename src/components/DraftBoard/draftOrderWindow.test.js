...
// the whole room to read a label the window now returns directly. This suite
// proves the window's own arithmetic only; the render path through
// rosterViewFor -> RosterNeedsStrip is asserted by the room cases in
// DraftBoard.test.jsx (#825).
// ---------------------------------------------------------------------------
