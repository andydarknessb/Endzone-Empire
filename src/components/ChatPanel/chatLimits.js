 ...
 * server's limit and the chat_messages.message varchar(500) column count: Unicode
...
/** The composer text's length in Unicode code points - the unit the server's
 *  limit and the varchar column both count. Array.from walks the string by its
