 ...
 * it. #1264 copies the same scan here for the Pickem game entity, the same
 * rule ADR 0029's `entities/matchup` docblock template describes.
 *
...
const THIS_ENTITY = path.basename(ENTITY_ROOT); // 'pickem-game'
...
test('no file under entities/pickem-game imports from another entity slice', () => {
