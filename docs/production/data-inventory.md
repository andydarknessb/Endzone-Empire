...
| Chat messages and reports | League communication and abuse handling | Render API, Supabase Postgres | Chat: 730 days; reports according to incident/legal need | User messages deleted; necessary report evidence handled under legal hold |
