 ...
 * chat history and the co-commissioner roster (both reference users, not
 * teams), and reads back with null Team identity rather than dropping out of
 * the result. On Pick history the LEFT join is defensive rather than
