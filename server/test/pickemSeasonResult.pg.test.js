...
const ENABLED = process.env.PG_TESTS === '1' || process.env.PICKEM_SEASON_RESULT_PG_TESTS === '1';
...
if (!ENABLED) {
  test('Pick\'em season result PG tests (skipped: set PG_TESTS=1 or PICKEM_SEASON_RESULT_PG_TESTS=1; CI migration-smoke runs these)', { skip: true }, () => {});
